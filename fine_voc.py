...
if __name__ == '__main__':
    random.seed(4096)
    weight = "/data/chenzh/AirTrans/results/air_trans_20230909_decoder_32->100/result_voc_r50_5way_5shot_lr0.002/weights/AirTrans_60_1305.pth"
    way_shot_train(5, 5, 2e-04, loss_weights0, 0, 'fine_conv', split_cats=novel_ids_voc1)
