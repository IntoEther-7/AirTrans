...
def way_shot_train(way, shot, lr, loss_weights, gpu_index, loss_weights_index, split_cats):
    save_root = '/data/chenzh/AirTrans/results/air_trans_{}/result_fsod_r50_{}way_{}shot_lr{}' \
        .format(loss_weights_index, way, shot, lr)
    model = AirTrans(
        # box_predictor params
        way, shot, roi_size=5, num_classes=way,
        # backbone
...
if __name__ == '__main__':
    random.seed(4096)
    way_shot_train(5, 5, 2e-04, loss_weights0, 0, '20230902_init', split_cats=None)
